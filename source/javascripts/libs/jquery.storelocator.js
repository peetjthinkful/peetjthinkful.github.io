  ...
  $(function(){
        ...
        success: function (data, xhr, options){
            ...
            if(settings.dataType === 'json' || settings.dataType === 'jsonp'){
              ...
              $.each(data, function(){
                ...
                if(settings.maxDistance === true && firstRun !== true && maxDistance){
                  ...
                  if(locationData.category === parseInt(selectedCat, 10)){
                    locationset[i] = locationData;
                  }
                  else{
                    return;
          ...
          if(settings.maxDistance === true && firstRun !== true && maxDistance){
            ...
            /**
             * PJ - added a length check for locationset - 14 Mar 2014
             */
            if(settings.distanceAlert !== -1 && locationset.length > 0 && locationset[0]['distance'] > settings.distanceAlert){
